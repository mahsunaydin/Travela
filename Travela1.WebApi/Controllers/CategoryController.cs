...
namespace Travela1.WebApi.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult CreateCategory(Category category) // eski adı CategoryList aksilik olursa düzelt
        {
        ...
        public IActionResult UpdateCategory(Category category)
        {
            ...
            return Ok("Kategori güncelleme işlemi başarı ile tamamlandı");
